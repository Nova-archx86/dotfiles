...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(python
     ...
     ;; better-defaults
     emacs-lisp
     (elfeed :variables rmh-elfeed-org-files (list "~/org/elfeed/elfeed1.org"))
     elfeed-org
     git
     zig
     helm
